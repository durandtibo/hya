...
| `hya`    | `braceexpand`<sup>*</sup> | `omegaconf`  | torch`<sup>*</sup> | `python`      |
|----------|---------------------------|--------------|--------------------|---------------|
| `main`   | `>=0.1.7,<0.2.0`          | `>=2.1,<3.0` | `>=1.10,<2.2`      | `>=3.9,<3.12` |
| `0.1.0`  | `>=0.1.7,<0.2.0`          | `>=2.1,<3.0` | `>=1.10,<2.2`      | `>=3.9,<3.12` |
| `0.0.14` | `>=0.1.7,<0.2.0`          | `>=2.1,<3.0` | `>=1.10,<2.2`      | `>=3.9,<3.12` |
